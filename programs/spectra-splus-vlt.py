...
for fitname, wl_, FLUX_, wl_filter, mag_arr_, mag_err_arr_, colors, marker_ in zip(fits_, WL, FLUX, repeated_wl_sp, mag_arr, err_, repeated_color, repeated_marker):
    print(marker_[13])
    ...
    # # F /= 1e-15
    # #F *= factor
    ax.scatter(wl_filter, F, c = colors, s=80, marker = "o", zorder=4)
